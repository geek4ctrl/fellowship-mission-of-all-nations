        ...
        <footer id="footer" className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 px-6 py-10 w-full">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-10 justify-between items-start">
                ...
                <div className="flex-1 min-w-[220px] flex flex-col gap-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-sm mb-2">A Place of Worship, Fellowship, and Service.</p>
                    <div className="flex gap-3 mb-2">
                        <a href="#" className="hover:scale-110 transition-transform"><svg className="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" /></svg></a>
                        <a href="#" className="hover:scale-110 transition-transform"><svg className="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 24 24"><rect x="4" y="4" width="16" height="16" rx="4" /></svg></a>
                        <a href="#" className="hover:scale-110 transition-transform"><svg className="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2v20M2 12h20" /></svg></a>
                        <a href="#" className="hover:scale-110 transition-transform"><svg className="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" /></svg></a>
                    </div>
                ...
                <div className="flex-[2] grid grid-cols-2 md:grid-cols-4 gap-8 w-full">
                    <div>
                        <h4 className="font-bold text-gray-700 dark:text-gray-200 mb-2">Product</h4>
