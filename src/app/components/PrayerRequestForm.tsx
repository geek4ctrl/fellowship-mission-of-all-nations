    ...
    return (
        <>
            ...
            >
                ...
                <div className="relative w-16 h-16 bg-gradient-to-br from-purple-600 via-pink-600 to-indigo-600 rounded-full shadow-2xl flex items-center justify-center transform transition-all duration-300 group-hover:scale-110 border-2 border-white/30">
                        ...
                        <div className="relative bg-white dark:bg-gray-900 rounded-3xl shadow-2xl border-2 border-indigo-200 dark:border-indigo-800 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                            ...
                            <form onSubmit={handleSubmit} className="p-6 space-y-6">
                                ...
                                <button 
                                    ...
                                    className="w-full px-8 py-4 font-bold text-white text-base bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 hover:from-purple-700 hover:via-pink-700 hover:to-indigo-700 rounded-xl shadow-2xl transform hover:scale-[1.02] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-2"
                                >
                                    {isSubmitting ? (
                                        <>
