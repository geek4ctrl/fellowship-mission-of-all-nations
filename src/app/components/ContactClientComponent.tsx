...
export default function ContactClientComponent() {
    ...
    <div className="max-w-screen-xl mx-auto px-4 xs:px-6 text-gray-600 dark:text-gray-300 md:px-8">
                    ...
                    <div className="flex flex-col items-center gap-y-7 gap-x-6 [&>*]:w-full sm:flex-row">
                        <div className="flex flex-col gap-4 w-full">
                            <div className="flex-1">
                                ...
                                <input id="firstName" name="firstName" type="text" required className="w-full mt-2 px-4 py-3 text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-900 outline-none border border-gray-300 dark:border-gray-700 focus:border-indigo-600 dark:focus:border-indigo-400 shadow rounded-xl transition-all" />
                            </div>
                            <div className="flex-1">
                                <label htmlFor="lastName" className="font-semibold text-gray-700 dark:text-gray-200">Last name</label>
                                <input id="lastName" name="lastName" type="text" required className="w-full mt-2 px-4 py-3 text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-900 outline-none border border-gray-300 dark:border-gray-700 focus:border-indigo-600 dark:focus:border-indigo-400 shadow rounded-xl transition-all" />
                            </div>
                        </div>
                    </div>
                    <div>
                        <label htmlFor="email" className="font-semibold text-gray-700 dark:text-gray-200">Email</label>
                        <input id="email" name="email" type="email" required className="w-full mt-2 px-4 py-3 text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-900 outline-none border border-gray-300 dark:border-gray-700 focus:border-indigo-600 dark:focus:border-indigo-400 shadow rounded-xl transition-all" />
                    </div>
                    <div>
                        ...
                        <div className="flex gap-2 mt-2">
                            ...
                            <input id="phone" name="phone" type="tel" required placeholder="+27 (786) 593-260" className="flex-1 px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-200 outline-none focus:border-indigo-600 dark:focus:border-indigo-400 shadow transition-all" />
                        </div>
                    </div>
                    <div>
                        <label htmlFor="message" className="font-semibold text-gray-700 dark:text-gray-200">Message</label>
                        <textarea id="message" name="message" required className="w-full mt-2 px-4 py-4 text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-900 outline-none border border-gray-300 dark:border-gray-700 focus:border-indigo-600 dark:focus:border-indigo-400 shadow rounded-xl transition-all" rows={5}></textarea>
                    </div>
